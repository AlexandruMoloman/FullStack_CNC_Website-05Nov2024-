        ...
        <StyledCol md={4}>
          <StyledCard>
            ...
            <Card.Body>
              ...
              <Card.Text>{limitText(textData.forza.text, 100)}</Card.Text>{' '}
        ...
        <StyledCol md={4}>
          <StyledCard>
            ...
            <Card.Body>
              ...
              <Card.Text>{limitText(textData.lavori.text, 100)}</Card.Text>{' '}
              {/* Ограничение символов */}
              <Link to="targetElement" smooth duration={500}>
                <StyledButton variant="primary">Scopri di Piu</StyledButton>
              </Link>
        ...
        <StyledCol md={4}>
          <StyledCard>
            ...
            <Card.Body>
              ...
              <Card.Text>{limitText(textData.stabilita.text, 100)}</Card.Text>{' '}
              {/* Ограничение символов */}
              <Link to="targetElement" smooth duration={500}>
                <StyledButton variant="primary">Scopri di Piu</StyledButton>
              </Link>
