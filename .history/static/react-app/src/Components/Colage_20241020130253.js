...
function ImageCollage() {
  return (
    <StyledCarousel data-bs-theme="dark" interval={2000} controls touch>
      <StyledCarouselItem>
        <img className="d-block w-100 mx-auto" src={big1} alt="First slide" />
      </StyledCarouselItem>

      <StyledCarouselItem>
        <img className="d-block w-100 mx-auto" src={ok15} alt="Second slide" />
      </StyledCarouselItem>

      <StyledCarouselItem>
        <img className="d-block w-100 mx-auto" src={dos1} alt="Third slide" />
      </StyledCarouselItem>
    </StyledCarousel>
  );
}
