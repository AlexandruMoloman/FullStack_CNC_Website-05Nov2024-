    ...
    <Carousel activeIndex={index} onSelect={handleSelect} style={{ backgroundColor: 'white' }}>
      <Carousel.Item>
        ...
        <Col className="mx-auto d-flex flex-column align-items-center justify-content-center text-center py-3">
          <h3 className="display-2">Pneumatica</h3>
          <p class2ame="lead">50%</p>
        </Col>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        />
        <Col className="mx-auto d-flex flex-column align-items-center justify-content-center text-center py-3">
          <h3 className="display-2">Automotive</h3>
          <p class2ame="lead">20%</p>
        </Col>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        />
        <Col className="mx-auto d-flex flex-column align-items-center justify-content-center text-center py-3">
          <h3 className="display-2">Oliodinamica</h3>
          <p class2ame="lead">15%</p>
        </Col>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        />
        <Col className="mx-auto d-flex flex-column align-items-center justify-content-center text-center py-3">
          <h3 className="display-2">Varia</h3>
          <p class2ame="lead">15%</p>
        </Col>
      </Carousel.Item>
    </Carousel>
