  ...
  return (
    <MapContainer>
      <iframe
        ...
        width="100%"
        height="100%"
        style={{ border: 0 }} /* В React style нужно задавать как объект */
        allowFullScreen /* Используйте camelCase для атрибутов в React */
        loading="lazy"
        referrerPolicy="no-referrer-when-downgrade" /* тоже в camelCase */
      ></iframe>
    </MapContainer>
  );
};
