...
export const ProdottiSlider = () => {
  ...
  return (
    <Carousel
      ...
      style={{ background: 'linear-gradient(darkred, #212529)' }}>
      <Carousel.Item>
        <img
          src={pneumatica}
          alt="Pneumatica"
        ...
        />
        <Col
          className="mx-auto d-flex flex-column align-items-center justify-content-center text-center py-3"
          style={{ color: 'white' }}>
          <h3 className="display-8">Pneumatica</h3>
          <p className="lead" style={{ fontstyle: '50px' }}>
            50%
          </p>
        </Col>
      </Carousel.Item>
