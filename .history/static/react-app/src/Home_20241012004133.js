    ...
    <>
        ...
        <Row xs={1} md={1} lg={2} xl={2}>
          <Col md={6}>
            <Text>
              <p>
                {' '}
                Siamo orientati a fornire soluzioni di alta qualità nel campo delle tecnologie CNC.
                Il nostro team utilizza tecnologie moderne e strumenti precisi per misurare il
                diametro e la distanza, permettendoci di creare prodotti con un alto livello di
                precisione e affidabilità. Comprendiamo che ogni progetto è unico, quindi offriamo
                approcci personalizzati che soddisfano le esigenze specifiche dei clienti.
              </p>
              <p>
                Il nostro obiettivo non è solo quello di portare a termine i compiti, ma anche di
                puntare a un miglioramento costante. Ci adattiamo attivamente ai cambiamenti e alle
                nuove sfide, il che ci consente di rimanere competitivi. Siamo orientati a garantire
                alti standard di qualità, utilizzando metodologie e tecnologie comprovate che
                consentono di raggiungere risultati ottimali in ogni progetto.
              </p>
            </Text>
          </Col>
      ...
      <Container className="py-4">
        <Row>
          ...
          <Col md={6}>
            <img
              src="./static/media/azienda.f18f05aaf59e5ec1dfbc.jpg"
              alt="Azienda"
              className="img-fluid mt-2"
              style={{ width: '100%', marginTop: '1rem' }}
            />
