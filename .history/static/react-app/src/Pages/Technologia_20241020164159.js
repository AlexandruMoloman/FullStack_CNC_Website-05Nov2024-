...
Il micrometro è uno strumento di precisione utilizzato per misurare dimensioni molto piccole, come spessori, diametri e profondità, con una precisione di solito fino a 0,01 mm. È composto da un cilindro filettato e una scala graduata, permettendo di ottenere misurazioni estremamente precise. A differenza del calibro, che può misurare una gamma più ampia di dimensioni e ha una precisione inferiore (solitamente intorno a 0,1 mm), il micrometro è specificamente progettato per misurazioni di alta precisione. Grazie alla sua costruzione robusta e alla capacità di misurare piccole variazioni, è essenziale in settori come la meccanica di precisione e l'ingegneria.
          </Col>
          <Col md={6} className="text-center">
            <StyledImage
              src={pro}
