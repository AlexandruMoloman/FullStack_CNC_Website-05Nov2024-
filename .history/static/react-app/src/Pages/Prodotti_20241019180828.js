          ...
          <Row className="align-items-center">
            ...
            <Col md={6}>
              <Col className="d-flex justify-content-center">
                <RoundImage src={lb15} alt="Operaio" className="img-fluid" />
              </Col>
            </Col>
          </Row>
          <Row className="align-items-center">
            <Col md={6} className="d-flex justify-content-center">
              <RoundImage src={pneuma} alt="Operaio" className="img-fluid" />
            </Col>
            <Col md={6}>
              <Subtitle>I nostri Prodotti CNC</Subtitle>
              <Text>
                "I nostri prodotti CNC rappresentano una combinazione perfetta di tecnologie
                avanzate e precisione, garantendo risultati eccezionali per i settori più esigenti.
                Ogni dettaglio è realizzato con precisione impeccabile, assicurando affidabilità e
                durata nell'uso. Siamo orgogliosi che le nostre soluzioni CNC permettano ai clienti
                di raggiungere la massima efficienza e produttività. Sviluppi innovativi e un
                rigoroso controllo qualità fanno dei nostri prodotti la scelta ideale per i
                professionisti. Offri al tuo business l'opportunità di beneficiare dei vantaggi
                delle alte tecnologie e dell'alta qualità."
              </Text>
            </Col>
          </Row>
        </Row>
