    ...
    <section style={{ background: 'linear-gradient(lightgrey, red, black)' }}>
      <StyledContainer>
        ...
        <Description>
          ...
          componenti. Siamo dedicati alldsdsdsdsdsdsdsdsd'innovazione continua e alla qualità, per
          garantire ai nostri clienti le soluzioni più avanzate.
        </Description>
          ...
          <Col md={4}>
            <StyledCard>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Utilizziamo software di progettazdsdsddsdsdione all'avanguardia per creare
