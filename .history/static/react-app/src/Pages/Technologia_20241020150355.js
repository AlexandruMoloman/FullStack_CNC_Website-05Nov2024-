      ...
      <Container fluid className="py-5">
        <Row className="align-items-center">
          <Col md={6}>
            ...
            <Description>
              Ciao! Sono Cristian, Capo Azienda CNC e Meccanico con oltre 30 anni di esperienza nel
              settore. Specializzato nella programmazione e operatività di macchinari a controllo
              numerico, ho guidato progetti complessi per l'industria meccanica di precisione. La
              mia passione è trovare soluzioni innovative per ogni sfida tecnica. Lavoro sempre con
              l'obiettivo di offrire qualità e affidabilità ai nostri clienti.
            </Description>
          </Col>
