    ...
    <>
      ...
      <Container
        ...
        <Row xs={1} md={1} lg={2} xl={2}>
          <Col md={6}>
            <Text>
              Siamo orientati a fornire soluzioni di alta qualità nel campo delle tecnologie CNC. Il
              nostro team utilizza tecnologie moderne e strumenti precisi per misurare il diametro e
              la distanza, permettendoci di creare prodotti con un alto livello di precisione e
              affidabilità. Comprendiamo che ogni progetto è unico, quindi offriamo approcci
              personalizzati che soddisfano le esigenze specifiche dei clienti. Il nostro obiettivo
              non è solo quello di portare a termine i compiti, ma anche di puntare a un
              miglioramento costante. Ci adattiamo attivamente ai cambiamenti e alle nuove sfide, il
              che ci consente di rimanere competitivi. Siamo orientati a garantire alti standard di
              qualità, utilizzando metodologie e tecnologie comprovate che consentono di raggiungere
