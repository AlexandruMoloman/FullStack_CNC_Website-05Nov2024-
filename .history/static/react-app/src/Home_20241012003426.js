    ...
    <>
      ...
      <Container
        ...
        <Row xs={1} md={1} lg={2} xl={2}>
          <Col md={6}>
            <Text>
              Noi siiamo specialisti nelle tecnologie CNC, che garantiscono la massima precisione e
              affidabilità in ogni fase della produzione. Grazie all'esperienza e alla
              professionalità del nostro team, offriamo soluzioni perfette per le vostre esigenze,
              dalla progettazione al prodotto finito. Ci scelgono per la qualità costante, il
              rispetto dei tempi e l'approccio innovativo.
            </Text>
          </Col>
