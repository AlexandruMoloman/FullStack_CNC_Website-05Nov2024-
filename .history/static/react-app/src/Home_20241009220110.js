...
import biglia from '../build/static/media/biglia.489910104651d3dd950c.png';
  ...
  return (
    <>
      ...
      <Container
        ...
        <Row xs={1} md={1} lg={2} xl={2}>
          ...
          <Col md={6} style={{ paddingTop: '0rem' }}>
            <img
              src={`${process.env.PUBLIC_URL}/static/media/biglia.46a8efc8c625a5a29a04.jpg`}
              alt="Biglia"
              className="img-fluid"
      ...
      <Container className="py-4">
        <Row>
          <Col md={6}>
            <img src={azienda} alt="Azienda" className="img-fluid mt-2" style={{ width: '100%' }} />
          </Col>
