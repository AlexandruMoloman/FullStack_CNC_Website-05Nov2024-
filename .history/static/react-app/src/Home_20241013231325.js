...
import img from './img/DJI_0346.jpg'; // Можно удалить, если не нужно
  ...
  return (
    <>
      ...
      <StyledContainer className="py-5">
        <Title>{content.text}Informazioni</Title> {/* Используем text из content */}
      </StyledContainer>
      ...
      <Container className="py-4">
        <Row>
          <Col md={6}></Col>
          {/* Теперь используем контент из пропсов */}
          {content.image && (
            <img
              src={URL.createObjectURL(content.image)} // Используем изображение из content
              alt="Azienda"
